...
|---|---|---|---|
| `paper` | Page background, default node fill | `#FFFFFF` | `#0D0D1A` (dark navy) |
| `paper-2` | Diagram container bg, secondary fill | `#F4F6F8` | `#161626` |
| `ink` | Primary text, primary stroke | `#0D0D1A` | `#F0F4F8` |
| `muted` | Secondary text, default arrow stroke | `#5A6275` | `#9AA4B2` |
| `soft` | Sublabels, boundary labels | `#7A8499` | `#6C788A` |
| `rule` | Hairline borders | `rgba(13,13,26,0.12)` | `rgba(240,244,248,0.12)` |
| `rule-solid` | Stronger borders, baselines | `#D0D7DE` | `rgba(208,215,222,0.25)` |
| `accent` | Focal / 1–2 max per diagram | `#53C1AB` (mint GI) | `#53C1AB` |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(83,193,171,0.08)` | `rgba(83,193,171,0.12)` |
| `link` | HTTP/API calls, external arrows | `#3E91AF` (cyan GI) | `#3E91AF` |

> **Brand palette source:** Grupo Inteligencia official palette — `#0D0D1A` dark navy, `#06231C` dark green, `#53C1AB` mint, `#3E91AF` cyan, `#E76F51` coral, with `Space Grotesk` and `Syne` typography.
