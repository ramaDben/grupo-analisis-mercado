...
Ejecuta el comando actualizacion de la misma forma que Claude Code.
...
2. Lee `.claude/commands/actualizacion.md` **completo**. Ese archivo es la definición
...
`.claude/commands/actualizacion.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/actualizacion.md`. -->
