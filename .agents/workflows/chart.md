...
Genera un screenshot de MT5 con el indicador y la temporalidad elegidos.
...
2. Lee `.claude/commands/chart.md` **completo**. Ese archivo es la definición
...
`.claude/commands/chart.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/chart.md`. -->
