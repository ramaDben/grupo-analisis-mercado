...
Ejecuta el comando ventas de la misma forma que Claude Code.
...
2. Lee `.claude/commands/ventas.md` **completo**. Ese archivo es la definición
...
`.claude/commands/ventas.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/ventas.md`. -->
