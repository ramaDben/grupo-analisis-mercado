...
Ejecuta el comando encuesta de la misma forma que Claude Code.
...
2. Lee `.claude/commands/encuesta.md` **completo**. Ese archivo es la definición
...
`.claude/commands/encuesta.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/encuesta.md`. -->
