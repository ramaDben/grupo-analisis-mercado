...
2. Lee `.claude/commands/carrusel.md` **completo**. Ese archivo es la definición
...
`.claude/commands/carrusel.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/carrusel.md`. -->
