...
Ejecuta el comando earnings de la misma forma que Claude Code.
...
2. Lee `.claude/commands/earnings.md` **completo**. Ese archivo es la definición
...
`.claude/commands/earnings.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/earnings.md`. -->
