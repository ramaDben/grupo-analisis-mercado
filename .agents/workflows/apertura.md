...
Niveles técnicos del día: pregunta activo, temporalidad e indicador, y arma el mensaje de apertura.
...
2. Lee `.claude/commands/apertura.md` **completo**. Ese archivo es la definición
...
`.claude/commands/apertura.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/apertura.md`. -->
