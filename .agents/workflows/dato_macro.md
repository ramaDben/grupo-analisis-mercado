...
Lista los datos económicos del día y arma la pieza del que elija el director, en modo anticipación o resultado.
...
2. Lee `.claude/commands/dato_macro.md` **completo**. Ese archivo es la definición
...
`.claude/commands/dato_macro.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/dato_macro.md`. -->
