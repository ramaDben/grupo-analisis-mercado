...
Ejecuta el comando viernes_pm de la misma forma que Claude Code.
...
2. Lee `.claude/commands/viernes_pm.md` **completo**. Ese archivo es la definición
...
`.claude/commands/viernes_pm.md` está escrito para otro runner y espera sus
...
<!-- Generado por scripts/agy_workflows.py. No editar a mano: el próximo
     ...
     comando, se edita `.claude/commands/viernes_pm.md`. -->
