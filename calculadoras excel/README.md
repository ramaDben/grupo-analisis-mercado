...
| **Recorrido adverso hasta la llamada a margen** | cuánto puede moverse el precio en contra, en la unidad del instrumento, antes de que el broker llame a margen. Responde con la mecánica del margen la pregunta que provoca el apalancamiento, sin necesidad de stop loss. Se calcula sobre la **posición neta**: todas las operaciones son del mismo instrumento, así que el precio se mueve en una sola dirección y una compra y una venta no pueden perder a la vez. Queda en blanco si la cartera está perfectamente cubierta, porque entonces no hay precio que la liquide. En el ejemplo cargado son **21,62 pesos** de USD/CLP |
